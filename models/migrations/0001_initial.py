# Generated by Django 3.2.18 on 2023-04-23 20:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('SUPERADMIN', 'SUPERADMIN'), ('ADMIN;SELLER', 'ADMIN;SELLER'), ('NORMAL', 'NORMAL')], max_length=64)),
            ],
            options={
                'db_table': '_user',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photos', models.ManyToManyField(related_name='product_photoses', to='models.File')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=100)),
                ('stock', models.IntegerField(default=0)),
                ('photos', models.ManyToManyField(related_name='variantoption_photoses', to='models.File')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sales', to='models.product')),
        ...
        migrations.AddField(
            model_name='user',
            name='photo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='user_photos', to='models.file'),
        ),
        migrations.AddField(
            model_name='user',
